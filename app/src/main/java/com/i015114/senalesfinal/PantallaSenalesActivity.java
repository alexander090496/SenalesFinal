package com.i015114.senalesfinal;
...
public class PantallaSenalesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pantalla_senales);textViewusuario=(TextView)findViewById(R.id.id_log_usuario);
        ...
        authStateListener=(new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                if(firebaseAuth.getCurrentUser() != null){
                    ...
                    databaseReference.child(firebaseAuth.getCurrentUser().getUid()).addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            ...
                            if(imageUrl.equals("default") || TextUtils.isEmpty(imageUrl)){
                                Picasso.with(PantallaSenalesActivity.this).load(Uri.parse(dataSnapshot.child("image").getValue().toString())).into(imageViewusu);
                            }
                        }
                    ...
                    startActivity(new Intent(PantallaSenalesActivity.this,LoginActivity.class));
                    finish();
                }
